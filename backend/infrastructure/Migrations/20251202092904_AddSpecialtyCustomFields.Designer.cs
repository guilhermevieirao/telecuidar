...
namespace app.Infrastructure.Migrations
{
    ...
    [Migration("20251202092904_AddSpecialtyCustomFields")]
    partial class AddSpecialtyCustomFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("app.Domain.Entities.AppointmentFieldValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("SpecialtyFieldId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SpecialtyFieldId");

                    b.ToTable("AppointmentFieldValues");
                });
            ...
            modelBuilder.Entity("app.Domain.Entities.ScheduleBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("AdminJustification")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("app.Domain.Entities.SpecialtyField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("app.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("app.Domain.Entities.User", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("app.Domain.Entities.AppointmentFieldValue", b =>
                {
                    ...
                    b.HasOne("app.Domain.Entities.SpecialtyField", "SpecialtyField")
                        .WithMany("AppointmentFieldValues")
                        .HasForeignKey("SpecialtyFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Appointment");

                    b.Navigation("SpecialtyField");
                });
            ...
            modelBuilder.Entity("app.Domain.Entities.ScheduleBlock", b =>
                {
                    b.HasOne("app.Domain.Entities.User", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("app.Domain.Entities.SpecialtyField", b =>
                {
                    b.Navigation("AppointmentFieldValues");
                });
