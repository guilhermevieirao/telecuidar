...
import { SpecialtiesService, Specialty, SpecialtiesFilter, SpecialtiesSortOptions, SpecialtyStatus } from '../../../core/services/specialties.service';
import { SpecialtyStatusPipe } from '../../../shared/pipes/specialty-status.pipe';
import { SpecialtyCreateModalComponent } from './specialty-create-modal/specialty-create-modal';
import { SpecialtyEditModalComponent } from './specialty-edit-modal/specialty-edit-modal';
import { AssignSpecialtyModalComponent } from './assign-specialty-modal/assign-specialty-modal';
